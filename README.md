...
This is the .NET Backend for the Student Management System assignment. It handles student records, state management, and photo uploads using raw SQL (ADO.NET) with JWT Authentication.
...
### 2. Database Setup (Run this Script)
Open **SQL Server Management Studio (SSMS)** and execute the following script. It will automatically create the database (`StudentDB`), tables, and default data.
